    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a class="nav-link left" href="../index.php"><i class="fas fa-home"></i><strong> Home </strong></a>
        </li>
        <li class="nav-item ">
          <a href="vistaPublicaciones.php" class="nav-link left"><i class="fas fa-users"></i><strong> Amigos</strong></a>
        </li>
        <?php if (isset($_SESSION['usuarios'])) { ?>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fas fa-cogs"></i><strong> Opcion</strong>
            </a>
